...
<!-- Scholarships Hero -->
    <section class="relative pt-40 pb-20 bg-[#0b1b3d] font-sans overflow-hidden text-center">
        <div class="container mx-auto px-6 relative z-10">
            <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-4">Global <span class="text-[#ffc107]">Scholarships</span></h1>
            <p class="text-gray-300 max-w-2xl mx-auto">Unlock financial aid opportunities and fully-funded programs at the world's best universities.</p>
        </div>
    </section>
    ...
    <section class="py-20 bg-light">
        <div class="container mx-auto px-6 max-w-4xl">
            <div class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 flex flex-col md:flex-row gap-8 items-center mb-12">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-[#0b1b3d] mb-2">Merit-Based Excellence Awards</h2>
                    <p class="text-gray-600 mb-4">Many of our partner universities in the UK and Australia offer significant tuition fee discounts (up to 50%) for students with outstanding academic records.</p>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 flex flex-col md:flex-row gap-8 items-center">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-[#0b1b3d] mb-2">Government & Regional Scholarships</h2>
                    <p class="text-gray-600 mb-4">We specialize in helping students apply for regional government scholarships (such as DSU in Italy or DAAD in Germany) which can cover full tuition and provide living stipends.</p>
